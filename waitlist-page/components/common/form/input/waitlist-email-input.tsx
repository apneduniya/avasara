...
import { IWaitlistSchema } from "@/schema/waitlist";


export default function WaitlistEmailInput({ register }: { register: UseFormRegister<IWaitlistSchema>}) {
